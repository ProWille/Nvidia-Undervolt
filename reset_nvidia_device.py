...
def reset_locked_clocks(device) -> None:
...
def reset_gpu_clock_offsets(device) -> None:
...
def reset_memory_clock_offsets(device) -> None:
...
def main():
    try:
        ...
        reset_locked_clocks(device=device)
        reset_power_limit(device=device)
        reset_gpu_clock_offsets(device=device)
        reset_memory_clock_offsets(device=device)
